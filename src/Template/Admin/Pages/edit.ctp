                ...
                <figure class="form-group">
                  <ul id="sortable" style="list-style:none;padding:0;">
                    <?php foreach($page->pages_components as $key=>$page_component):?>
                      <?php if($page_component->component=='banner'):?>
                      ...
                      <?php elseif($page_component->component=='html'):?>
                      <li style="cursor:move" data-sort="<?=$page_component->sort;?>">
                        <?php echo $this->Form->hidden('pages_components.'.$key.'.id', ['class'=>'form-control']);?>
                        <?php echo $this->Form->hidden('pages_components.'.$key.'.sort', ['class'=>'form-control sortfield']);?>
                        <?php echo $this->Form->control('pages_components.'.$key.'.content', ['class'=>'form-control ckeditor', 'label'=>$page_component->caption]);?>
                      </li>
                       <?php elseif($page_component->component=='left_slider'):?>
                      <li style="cursor:move" data-sort="<?=$page_component->sort;?>">
                        <?php echo $this->Form->hidden('pages_components.'.$key.'.id', ['class'=>'form-control']);?>
                        <?php echo $this->Form->hidden('pages_components.'.$key.'.sort', ['class'=>'form-control sortfield']);?>
                        <?php echo $this->Form->control('pages_components.'.$key.'.content', ['class'=>'form-control ckeditor', 'label'=>$page_component->caption]);?>
                      </li>
                      <?php elseif($page_component->component=='element'):?>
                      <li style="cursor:move" data-sort="<?=$page_component->sort;?>">
                        <?php echo $this->Form->hidden('pages_components.'.$key.'.id', ['class'=>'form-control']);?>
                        <?php echo $this->Form->hidden('pages_components.'.$key.'.sort', ['class'=>'form-control sortfield']);?>
                      ...
                      <?php elseif($page_component->component=='default-title'):?>
                      <li style="cursor:move" data-sort="<?=$page_component->sort;?>">
                        <?php echo $this->Form->hidden('pages_components.'.$key.'.id', ['class'=>'form-control']);?>
                        <?php echo $this->Form->hidden('pages_components.'.$key.'.sort', ['class'=>'form-control sortfield']);?>
                        <?php echo $this->Form->control('pages_components.'.$key.'.class', ['class'=>'form-control', 'type'=>'text','label'=>$page_component->caption]);?>
                        <?php echo $this->Form->control('pages_components.'.$key.'.content', ['class'=>'form-control', 'type'=>'textarea','label'=>'Conteúdo']);?>
                      </li>
                      <?php endif;?>
                      <?php endforeach;?>
                  </ul>
